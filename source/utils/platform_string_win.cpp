...
std::string winapi_to_utf8(const wchar_t *strb, const wchar_t *stre)
{
...
std::string winapi_to_utf8(const std::wstring_view& u16str)
{
...
std::wstring utf8_to_winapi(const std::string_view& u8str)
{
